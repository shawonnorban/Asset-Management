        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('report-issue.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script src="<?php echo e(asset('assets/js/page/html5-qrcode.min.js')); ?>"></script>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Enterprise-Asset-Management\resources\views/report-issue/index.blade.php ENDPATH**/ ?>