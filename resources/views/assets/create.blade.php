...
@section('content')
    ...
    <div class="section-body">
        <form action="{{ route('aset.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="kode_aset" type="text"
                                       ...
                                       name="kode_aset" value="{{ old('kode_aset') }}" maxlength="35" required>
                                @error('kode_aset')
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama_aset" type="text"
                                       ...
                                       name="nama_aset" value="{{ old('nama_aset') }}" maxlength="150" required>
                                @error('nama_aset')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="merek" type="text"
                                       ...
                                       name="merek" value="{{ old('merek') }}" maxlength="100">
                                @error('merek')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input id="tgl_penambahan" type="date"
                                       ...
                                       name="tgl_penambahan" value="{{ old('tgl_penambahan', date('Y-m-d')) }}" required>
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <div class="form-group text-center">
                                <img src="" id="preview" class="img-preview img-fluid mb-3 mt-2"
                                     style="border-radius: 5px; max-height:300px; object-fit: contain;">
                            </div>

                            <div class="form-group">
                                <label for="gambar">Gambar (jpeg/jpg/png)</label>
                                ...
                                @error('gambar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Maks 4MB. Tidak wajib.</small>
                            </div>
    ...
    {{-- JS: set tanggal default (already handled by value attr) and preview image --}}
    <script>
